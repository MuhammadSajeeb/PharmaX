<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="PharmaX.WebApp.WebForm1" %>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>PharmaX - Pharmacy Management </title>
    ...
    <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Pharm<sup>Assistant</sup></div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" runat="server" href="Shelf/Setup.aspx">
                    <i class="fas fa-fw fa-list"></i>
                    <span>Shelfs Store</span></a>
            </li>

            <li class="nav-item">
                <a class="nav-link" runat="server" href="Category/Setup.aspx">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" runat="server" href="~/Item/Setup.aspx">Setup</a>
                        <a class="collapse-item" runat="server" href="~/Item/ViewAll.aspx">View All</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Supplier Details :</h6>
                        <a class="collapse-item" runat="server" href="~/Supplier/Setup.aspx">Setup</a>
                        <a class="collapse-item" runat="server" href="~/Supplier/ViewAll.aspx">View All</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePurchase" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Purchase Details :</h6>
                        <a class="collapse-item" runat="server" href="~/Purchase/Entry.aspx">Entry</a>
                        <a class="collapse-item" runat="server" href="~/Purchase/ViewAll.aspx">View All</a>
                    </div>
                </div>
            </li>
