<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Setup.aspx.cs" Inherits="PharmaX.WebApp.Item.Setup" %>
                    ...
                    <div class="card-body card-block">
                        ...
                        <div class="form-group">
                            <div class="col-md-10 mb-2">
                                ...
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="ShelfsDropDownList"
                        ...
                        <div class="form-group">
                            <div class="col-md-10 mb-2">
                                ...
                                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtGenericName"
                                    CssClass="text-danger" ErrorMessage="This field is required." />
                            </div>
                        </div>
                        <div class="form-group">
