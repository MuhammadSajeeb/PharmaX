                    ...
                    <div class="form-group">
                        <asp:GridView ID="PurchaseListGridView" runat="server" Font-Size="Small" DataKeyNames="PurchaseId" EmptyDataText="No Items Available Now" Width="100%" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="10" ForeColor="Black" GridLines="Horizontal" AllowPaging="True" CellSpacing="1" OnSelectedIndexChanged="PurchaseListGridView_SelectedIndexChanged" OnRowCommand="PurchaseListGridView_RowCommand">
                            <Columns>
                                ...
                                <asp:ButtonField CommandName="PurchaseId" Text="Print">
